...
class AudioTranscriber:
    ...
    def __init__(self, model_size: str = WHISPER_MODEL, language: str = DEFAULT_LANGUAGE):
        ...
        self.segment_cache_size = config.get('insightron.services.transcription.segment_cache_size', 1000)
        self.enable_parallel_segment_processing = config.get('insightron.services.transcription.enable_parallel_segments', False)
